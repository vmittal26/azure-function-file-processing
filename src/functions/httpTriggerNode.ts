...
export const  httpTriggerNode = async(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit>=> {
...
app.http('httpTriggerNode', {
    methods: ['GET', 'POST'],
    authLevel: 'anonymous',
    handler: httpTriggerNode
});
